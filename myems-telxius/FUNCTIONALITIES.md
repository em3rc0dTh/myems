# 📡 Telxius DCIM - Manual de Funcionalidades Técnicas

Este documento detalla todas las capacidades implementadas en el sistema de monitorización Telxius para la gestión de infraestructura de racks y telemetría de energía.
...
*   **Protocolo MQTT**: Conexión nativa con el broker Telxius para lectura de telemetría AMC16Z en tiempo real.
