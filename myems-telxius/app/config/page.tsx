...
export default function ConfigPanel() {
    ...
    const saveToLocal = () => {
        localStorage.setItem('telxius_qdfs', JSON.stringify(qdfs));
        localStorage.setItem('telxius_meters', JSON.stringify(meters));
        localStorage.setItem('telxius_mappings', JSON.stringify(mappings));
        setSaved(true);
