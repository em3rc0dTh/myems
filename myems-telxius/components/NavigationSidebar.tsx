...
export default function NavigationSidebar() {
  ...
  return (
    <aside className="fixed left-6 top-1/2 -translate-y-1/2 z-[100] hidden lg:flex flex-col gap-4">
      <div className="bg-black/40 backdrop-blur-3xl border border-white/5 p-2.5 rounded-[32px] flex flex-col gap-2 shadow-2xl ring-1 ring-white/5">
        ...
        {NAV_ITEMS.map((item) => {
          ...
          if (item.href === '/') {
            ...
            // Activo si empieza por /topology/ PERO NO por /topology/dashboard/
          ...
          return (
            ...
            >
              ...
              {/* Tooltip / Label */}
              <div className="absolute left-full ml-6 opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-300 translate-x-4 group-hover:translate-x-0 whitespace-nowrap">
        ...
        {/* <div className="mt-4 pt-4 border-t border-white/5 flex flex-col gap-2">
            <button className="p-4 rounded-2xl text-slate-600 hover:text-white hover:bg-white/5 transition-all group relative">
                <HelpCircle className="w-5 h-5 transition-transform duration-500" />
            </button>
        </div> */}
      </div>
